    ...
    <div style=" width: 100%; height: 100%; background-color: white;">
        <el-card class="form-container" shadow="never">
            <el-row v-for="(item, index) in allItems">
                <el-col :span="5">
                    <div style="margin-top: 4px;">{{item.chnExplain}}</div>
                </el-col>
                <el-col :span="15">
                    <el-input style="width: 100%;" v-model="item.argValue"></el-input>
                </el-col>
                <el-col :span="2">
                    <div style="margin-top: 4px;">分钟</div>
                </el-col>
                <el-col :span="2" v-if="item.argValue!==oldAllItems[index].argValue">
            ...
            initData(){
                ...
                getSysMallConfig(this).then((res)=>{
                    ...
                    res.data.forEach((value)=>{
                        ...
                        if(item.argName.startsWith('mall_order_closetime')){
                        ...
                        if(item2.argName.startsWith('mall_order_closetime')){
